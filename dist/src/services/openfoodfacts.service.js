...
exports.searchOFFProducts = exports.fetchOFFProduct = void 0;
 ...
 */
const offApi = axios_1.default.create({
...
const searchOFFProducts = async (query, page = 1) => {
...
exports.searchOFFProducts = searchOFFProducts;
const parseOFFError = (err, context) => {
